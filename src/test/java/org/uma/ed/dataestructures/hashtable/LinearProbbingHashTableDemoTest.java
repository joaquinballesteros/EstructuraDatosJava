...
public class LinearProbbingHashTableDemoTest {
    private LinearProbingHashTable<String> table;
    ...
    public void testCopyOf() {
        ...
        LinearProbingHashTable<String> copy = LinearProbingHashTable.copyOf(table);
